...
(defun experiment2 ()
  ...
  (let* ((lisp-window (experiment-first-window))
         (events `((:RESIZE ((600 400)))
                   ...
                   (:assert (eq 1 (hash-table-count (gui-app:all-windows))))
                   (:assert (typep (gethash :testing  (gui-app:all-windows)) 'todo-window))
                   (:assert (null (~> (gui-app:all-windows)
                                      (gethash :testing _)
                   ...
                   (:PRESSED ((1 38.44976806640625d0 341.4234924316406d0)))
                   (:assert (eq 2  (~> (gui-app:all-windows)
                                       (gethash :testing _)
                                       (gui-window:children _)
                                       (nth 1 _)
                                       (gui-box:children _)
                   ...
                   (:RELEASED ((1 38.44976806640625d0 341.4234924316406d0)))
                   (:PRESSED ((1 38.44976806640625d0 341.4234924316406d0)))
                   (:assert (eq 3  (~> (gui-app:all-windows)
                                       (gethash :testing _)
                                       (gui-window:children _)
                                       (nth 1 _)
                                       (gui-box:children _)
                   ...
                   (:assert (equal "Remove" (~> (gui-app:all-windows)
                                                (gethash :testing _)
                                                (gui-window:most-current-widget _)
                                                (gui-box:text _))))

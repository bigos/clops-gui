...
(defun experiment2 ()
  ...
  (let ((lisp-window (experiment-first-window))
        (events ' ((:RESIZE ((600 400))) (:KEY-RELEASED (("" "Return" 36 NIL)))
                   (:TIMEOUT (NIL)) (:TIMEOUT (NIL)) (:MOTION-ENTER ((594.0d0 218.0d0)))
                   (:MOTION ((36.661827087402344d0 338.5277404785156d0))) (:TIMEOUT (NIL))
                   (:MOTION ((38.44976806640625d0 341.4234924316406d0))) (:TIMEOUT (NIL))
                   (:TIMEOUT (NIL))
                   ...
                   (:MOTION ((95.17391967773438d0 152.87742614746094d0))) (:TIMEOUT (NIL))
                   ...
                   (:TIMEOUT (NIL)) (:MOTION ((169.45411682128906d0 341.844970703125d0)))
                   (:TIMEOUT (NIL))
                   (:PRESSED ((1 169.45411682128906d0 341.844970703125d0)))
                   (:RELEASED ((1 169.45411682128906d0 341.844970703125d0)))
                   (:MOTION ((533.4215698242188d0 60.727294921875d0))) (:TIMEOUT (NIL))
                   (:TIMEOUT (NIL)) (:KEY-PRESSED (("e" "e" 26 NIL))))))
    (loop for event in events
          for e = (car event)
          for eargs = (caadr event)
